jQuery(function ($) {
    $(document).ready(function () {
        ...
        ws.onmessage = function(message){
            ...
            //     sfName:"haha"
            // };
            var signUserHtml = "<li class='animated rollIn' style='width: 10%;height:16%'><div style='text-align: center;'><img src='"+ user.wxHeadimgurl +"' style='border-radius: 50%;max-width: 90%;height: 100px;width: 100px;' alt='User Image'><a href='#' style='font-size: 20px;font-family: 微软雅黑, Microsoft YaHei;color: #0099FF;' class='users-list-name'>" + user.sfName + "</a></div></li>";
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(var i = iLen - 1 ; i >=0  ; i--){
                    userHtml += "<li style='width: 10%;height:16%'><div style='text-align: center;'><img style='border-radius: 50%;max-width: 90%;height: 100px;width: 100px;' src='"+ signedusers[i].wxHeadimgurl +"'alt='User Image'><a href='#' style='text-align: center;font-size: 20px;font-family: 微软雅黑, Microsoft YaHei;color: #0099FF;' class='users-list-name'>" + signedusers[i].sfName + "</a></div></li>";
                    // if((iLen - i)%10 == 0){
                    //     userHtml += "</tr><tr>";
                    // }
                }
